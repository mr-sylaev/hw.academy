<?
    $profileData = include_once ('./data/profile_data.php');
    $careerData = include_once ('./data/career_data.php');
?> 
<!DOCTYPE html>
...
<div class="wrapper">
    <div class="sidebar-wrapper">
        <div class="profile-container">
            <img class="profile" src="assets/images/<?=$profileData['about']['photo'] ?>" alt="<?=$profileData['about']['photo-alt'] ?>" />
        ...
        <div class="contact-container container-block">
            <ul class="list-unstyled contact-list">
                ...
                <li class="vk"><i class="fa fa-vk"></i><a href="//<?=$profileData['about']['vk'] ?>" target="_blank"><?=$profileData['about']['vk'] ?></a></li>
                <li class="github"><i class="fa fa-github"></i><a href="//<?=$profileData['about']['github'] ?>" target="_blank"><?=$profileData['about']['github'] ?></a></li>
            </ul>
        ...
        <div class="education-container container-block">
            ...
            <div class="item">
                ...
                <h5 class="meta"><?=$education['speciality'] ?></h5>
        ...
        <div class="interests-container container-block">
            <h2 class="container-block-title">Развлечения</h2>
            <ul class="list-unstyled interests-list">
    ...
    <div class="main-wrapper">
        ...
        <section class="section experiences-section">
            ...
            <? foreach($careerData['experiences'] as $experience): ?>
            <div class="item">
                <div class="meta">
                    <div class="upper-row">
                        <h3 class="job-title"><?=$experience['post'] ?></h3>
                        <div class="time"><?=$experience['yearStart'] ?> - <?=$experience['yearEnd'] ?: 'На сегодняшний день' ?></div>
                    </div><!--//upper-row-->
        ...
        <section class="section projects-section">
            ...
            <div class="intro">
                <p>Ниже Вы можете посмотреть несколько вариантов сайт, которые были сделаны мною под заказ на Фрилансе.</p>
            </div><!--//intro-->
        ...
        <section class="skills-section section">
            <h2 class="section-title"><i class="fa fa-rocket"></i>Навыки и Мастерство</h2>
            <div class="skillset">
