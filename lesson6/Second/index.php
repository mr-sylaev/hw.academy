<?php
    ...
    $twoD_Education = new TwoDimensional($profileData['education'], 'yearStart', 'yearEnd');
    $educations = ($twoD_Education->getSortedArray());

    $twoD_Languages = new TwoDimensional($profileData['languages'], 'title', 'level');
    $languages = ($twoD_Languages->getSortedArray());
?>
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="assets/images/<?=$profileData['about']['photo']?>" alt="" />
            ...
            <div class="interests-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <? foreach ($profileData['interests'] as $intereat): ?>
                        <li><?=$intereat ?></li>
                    <? endforeach; ?>
                </ul>
            </div><!--//interests-->
